    ...
    Route::middleware('guest')->group(function () {
        ...
        Route::post('user/login', 'FrontendController@loginSubmit')->name('login.submit')->middleware('throttle:6,1');
        Route::get('user/register', 'FrontendController@register')->name('register.form');
        Route::post('user/register', 'FrontendController@registerSubmit')->name('register.submit')->middleware('throttle:5,1');
    });
    ...
    Route::post('/contact/message', 'MessageController@store')->name('contact.store')->middleware('throttle:5,1');
    ...
    Route::group(['prefix' => '/admin', 'middleware' => ['auth', 'admin']], function () {
        Route::get('/products-list', function () {
            return \App\Models\Product::pluck('title');
        })->name('admin.products.list');

        Route::get('/dashboard', 'DashboardController@productOrderIncome')->name('product.order.dashboard');
        Route::get('/dashboard/payments', 'DashboardController@paymentMethodStats')->name('admin.dashboard.payments');
