      ...
      <form method="post" action="{{route('product.update',$product->id)}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <select name="condition" class="form-control">
              ...
              <option value="standard" {{($product->condition=='standard')? 'selected':''}}>Standard</option>
        ...
        <!-- Updated file input for device upload -->
        <div class="form-group">
          ...
          @if($product->photo)
            <img src="{{ asset($product->photo) }}" alt="Product Image" style="max-height:100px;margin-top:10px;">
          @endif
          @error('photo')
          <span class="text-danger">{{$message}}</span>
          @enderror
...
<script>
    ...
    if(child_cat_id!=null){ $('#cat_id').change(); }
</script>
@endpush
