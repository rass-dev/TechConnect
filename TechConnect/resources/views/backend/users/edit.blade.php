        ...
        <div class="tc-form-body">
            <form method="POST" action="{{ route('users.update', $user->id) }}" enctype="multipart/form-data">
                ...
                <div class="tc-form-grid">
                    ...
                    <div class="tc-form-photo-col">
                        <div class="tc-photo-upload" onclick="document.getElementById('photo').click()">
                            <img id="photo-preview"
                                 src="{{ $user->photo ? asset($user->photo) : asset('backend/img/avatar.png') }}"
                                 alt="{{ $user->name }}">
                        ...
                        <p class="tc-photo-hint">Click to change profile photo<br><small>JPG, PNG, GIF (max 2MB)</small></p>
                        @error('photo')
                    ...
                    <div class="tc-form-fields-col">
                        ...
                        <div class="tc-field-group">
                            <label class="tc-label" for="inputTitle">
                        ...
                        <div class="tc-field-group">
                            <label class="tc-label" for="inputEmail">
                        ...
                        <div class="tc-form-row">
                            ...
                            @auth
                                @if(auth()->user()->role === 'superadmin')
                                    @php $roles = ['admin', 'user', 'superadmin']; @endphp
                                    <div class="tc-field-group">
                ...
                <div class="tc-form-footer">
                    <a href="{{ route('users.index') }}" class="tc-btn tc-btn-secondary">
...
<style>
    ...
    .tc-input.is-invalid { border-color: #ef4444; }
    ...
    .tc-meta-item { display: flex; align-items: center; gap: 7px; font-size: 12px; color: #6b7280; }
    .tc-meta-item i { color: #996EF8; font-size: 11px; }
    ...
    .tc-btn-secondary:hover { background: #e5e7eb; color: #374151; text-decoration: none; }
</style>
@endpush
