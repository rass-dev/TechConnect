...
<div class="tc-page-card">
    <div class="tc-page-card-header">
        ...
        <a href="{{ route('category.create') }}" class="tc-btn-add">
        ...
        <div class="table-responsive">
            <table class="table tc-table" id="banner-dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    @endphp
                    <tr>
                        <td class="tc-td-num">{{ $category->id }}</td>
                        <td><span class="tc-cat-title">{{ $category->title }}</span></td>
                        <td>
                            @if($category->is_parent == 1)
                                <span class="tc-badge tc-badge-primary">Yes</span>
                            @else
                        ...
                        <td>
                            @foreach($parent_cats as $parent_cat)
                                <span class="tc-parent-cat">{{ $parent_cat->title }}</span>
                            @endforeach
                            @if($parent_cats->isEmpty())
...
<style>
    ...
    .tc-cat-title { font-weight: 600; color: #1F2340; }
    .tc-parent-cat { color: #6b7280; font-size: 13px; }
...
$(document).ready(function(){
    ...
    $(document).on('click', '.dltBtn', function(e){
        ...
        swal({
            ...
            else { swal("Your category is safe!"); }
        });
    });
});
</script>
