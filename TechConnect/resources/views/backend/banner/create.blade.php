...
@section('title', 'TechConnect | Banner Create')
...
<label for="inputTitle" class="col-form-label">Title <span class="text-danger">*</span></label>
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="show_title" name="show_title" value="1" {{ old('show_title') ? 'checked' : '' }}>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="show_description" name="show_description"
                                value="1" {{ old('show_description') ? 'checked' : '' }}>
