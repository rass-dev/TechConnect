        ...
        $('#contactForm').validate({
            ...
            messages: {
                ...
                message: {
                    ...
                    maxlength: "Your message cannot exceed 200 characters."
                }
            },
            errorElement: "span",
            errorClass: "field-error",
            highlight: function(element) {
                $(element).addClass('is-invalid').closest('.form-field').addClass('has-error');
            },
            unhighlight: function(element) {
                $(element).removeClass('is-invalid').closest('.form-field').removeClass('has-error');
            },
