    ...
    public function confirmDelivery($id)
{
    ...
    return redirect()->route('my-orders')->with('success', 'Order delivery confirmed successfully.');
}
...
public function cancel($id)
{
    ...
    // Prevent cancelling if already completed or already cancelled
    if (in_array($order->status, ['completed', 'cancel'])) {
    ...
    // Restore stock if order was not completed
    ...
    OrderHistory::create([
        ...
        'remarks' => "Order cancelled by " . (Auth::user()->name ?? 'system'),
    ]);
