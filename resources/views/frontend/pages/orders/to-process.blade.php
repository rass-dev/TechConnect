...
<div class="container py-4">
    <h4 class="mb-4" style="color:#2C185C;">Orders To Process</h4>
    ...
    @empty
        <p class="text-muted">No orders found in "To Process" tab.</p>
    @endforelse
</div>
@endsection
...
<style>
:root {
    --primary-color: #2C185C;
    --secondary-color: #ECE9FE;
    --accent-color: #996EF8;
    --dark-color: #2E1A5E;
    --highlight-color: #361F6F;
}
...
/* Status badges */
.status-new { background-color: var(--accent-color); color: #fff; }
.status-process { background-color: #996EF8; color: #fff; }
.status-on_the_way { background-color: #2E1A5E; color: #fff; }
.status-delivered { background-color: #4CAF50; color: #fff; }
.status-completed { background-color: var(--highlight-color); color: #fff; }
.status-cancel { background-color: #F44336; color: #fff; }
...
.btn-view:hover {
    background-color: #7a53d9; /* darker shade on hover */
}

/* Text Colors */
.order-card p { color: var(--dark-color); }
...
.d-flex.align-items-center.gap-3 span.badge {
    margin-right: 15px;
}
